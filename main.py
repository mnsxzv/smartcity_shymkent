...
async def analyze_text_with_ai(user_text):
    ...
    microrayons = { 
        ...
        "18": ("18-й микрорайон", 42.3382, 69.6053, 400),
        "11": ("11-й микрорайон", 42.3411, 69.5912, 400),
        "16": ("16-й микрорайон", 42.3333, 69.6050, 400),
        ...
        "самал": ("мкр. Самал", 42.3496, 69.5672, 750),
        "улагаat": ("мкр. Улагат", 42.337661, 69.674808, 600),
        "тассай": ("ж.м. Тассай", 42.3524, 69.6850, 950),
        "бозарык": ("мкр. Бозарык", 42.4331, 69.6160, 1100),
        "таскен": ("мкр. Таскен", 42.377084, 69.718032, 1200),
        "катын копр": ("ж.м. Катын Копр", 42.3221, 69.5352, 750),
        "шугыла": ("мкр. Шугыла", 42.360077, 69.574676, 550),
        "спортивный": ("Спортивный мкр.", 42.3394, 69.6131, 400),
        "спорт": ("Спортивный мкр.", 42.3394, 69.6131, 400),
        ...
        "онтустик": ("ж.м. Онтустик (Фосфорный)", 42.2570, 69.6231, 1000),
        "карасу": ("мкр. Карасу", 42.3275, 69.5880, 500),
        "север": ("мкр. Север", 42.3683, 69.5936, 600),
        "туран": ("мкр. Туран", 42.3552, 69.5414, 950),
        "куншыгыс": ("мкр. Куншыгыс", 42.3331, 69.6385, 450),
        "забадам": ("ж.м. Забадам", 42.2771, 69.5695, 850),
